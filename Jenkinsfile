pipeline {
    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/theengineer-pb/test-repo.git'
            }
        }
        ...
        stage('Checkout K8s YAML Repo') {
            steps {
                git branch: 'main', credentialsId: 'github-token', url: 'https://github.com/theengineer-pb/test-k8s.git'
            }
        }
